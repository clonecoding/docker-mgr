...
set JAVA_OPTS=-server -Xmx2g -Xms2g -Xmn1g -XX:+UseParallelGC -XX:ParallelGCThreads=4 -XX:+UseParallelOldGC -XX:+PrintGCTimeStamps -XX:+PrintGCDetails -Xloggc:d:\dockermgr\gclogs\gc-%p.log
