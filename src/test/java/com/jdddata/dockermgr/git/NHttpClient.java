...
public final class NHttpClient {
     ...
     */
    public static void send(String url, Map<String, String> map, final String encoding, final AsyncHandler handler) throws KeyManagementException, NoSuchAlgorithmException, ClientProtocolException, IOException, ExecutionException, InterruptedException {
...
//        final CloseableHttpAsyncClient client = proxy("127.0.0.1", 8087).setConnectionManager(connManager).build();
        final CloseableHttpAsyncClient client = HttpAsyncClientBuilder.create().setConnectionManager(connManager).build();
//		CloseableHttpAsyncClient client = HttpAsyncClients.createDefault();
        ...
        client.start();
        //执行请求操作，并拿到结果（异步）
        Future<HttpResponse> execute = client.execute(httpPost, new FutureCallback<HttpResponse>() {
