...
//        Pipeline pipeline = createPipelineLocal(projectName,gitUrl,gitVersion);
//        this.pipeline = pipeline;
//    }
//
//
...
//    }
//
//    private Pipeline createPipelineLocal(String projectName, String gitUrl, String gitVersion) {
//        Pipeline pipeline = new Pipeline();
//        pipeline.setLabelTemplate(PipelineConstants.LABEL_TEMPLATE);
//        pipeline.setLockBehavior("none");
//        pipeline.setName(projectName + "-maven");
